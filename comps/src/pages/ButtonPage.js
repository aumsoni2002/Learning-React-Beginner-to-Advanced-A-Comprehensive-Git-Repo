...
function ButtonPage() {
  ...
  return (
    <div>
      <div>
        {/* sending the 'primary' text as value to Button component through children prop*/}
...
-- The Children Prop
   ...
   Consider we have 'ButtonPage.js' as Parent Component and 'Button.js' as child component
   // ButtonPage.js
...
/*
-- Passing Event Handlers from ButtonPage.js to Button.js through Component Rendering Tag: Button
   // ButtonPage.js
   function ButtonPage() {
    const handleClick = () =>{
      console.log("Clicked!!");
...
-- Passing all remaining properties and values(mainly Event Handlers) in form of one object from ButtonPage.js to Button.js through spread operator
   // ButtonPage.js
   function ButtonPage() {
    const handleClick = () =>{
      console.log("Clicked!!");
   ...
   // Button.js
   // here we take all the remaining properties and values that are passed down from ButtonPage.js other than the once 
...
-- React Component Terminology
   Component:
   The word 'component' for a React Component is used when that perticular component is re-usable and shows a handleful of elements.
   Example: Button, DropDown, SearchBox, CheckBox ...

   Page:
   The word 'page' for a React Component is used when that perticular component is not intended to be re-used.
   Example: LandingPage, CheckoutPage, LoginPage, CarPage ...
